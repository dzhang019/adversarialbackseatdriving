...
if __package__ in (None, ""):
    ...
    from adv_steering.analyze_truth_lie_residuals import analyze_truth_lie_residuals
    from adv_steering.generate_truth_lie_corpus import generate_corpus
else:
    from .analyze_truth_lie_residuals import analyze_truth_lie_residuals
    from .generate_truth_lie_corpus import generate_corpus


def parse_args():
    parser = argparse.ArgumentParser(description="Run the full Qwen truth-vs-lie pipeline end to end.")
    ...
    parser.add_argument("--dataset", default="data/qwen_truth_lie_corpus.jsonl", help="Generated corpus path.")
...
def main():
    ...
    analysis_result = analyze_truth_lie_residuals(
        model=args.model,
        backend=args.backend,
